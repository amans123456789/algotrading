...
def strength_trend_func(end_date, n, n_daily):
    try:
        ...
        base_folder = 'time_series_data/trend_strength_indicator'

        new_folder_path = os.path.join(base_folder, folder_name)
        os.makedirs(new_folder_path, exist_ok=True)

        daily_strength_filename = os.path.join(new_folder_path, "daily_lag_indicator_{}.csv".format(folder_name))
        hourly_strength_filename = os.path.join(new_folder_path, "hourly_lag_indicator_{}.csv".format(folder_name))
